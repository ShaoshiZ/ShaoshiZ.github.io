...
// Toggle between light and dark theme settings (system mode disabled).
...
// System mode is disabled: on first visit we follow the OS preference once, but only
// ever store/return a concrete "light" or "dark" value.
